                ...
                {currentQuestion.image_url && (
                    currentQuestion.image_url.startsWith('data:application/pdf') || currentQuestion.image_url.endsWith('.pdf') ? (
                        <a 
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="mt-4 flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors"
                        >
                            ...
                            <div>
                                <div className="text-sm font-bold text-white">Документ к вопросу</div>
                                <div className="text-[11px] text-gray-400">Нажмите, чтобы открыть или скачать PDF</div>
                            </div>
                        </a>
                    ) : (
