        ...
        <div className="flex flex-col pb-32">
            ...
            <main className="p-4 flex flex-col gap-6">
                <form 
                    onSubmit={(e) => {
                        e.preventDefault()
                        createMutation.mutate({ title, description, duration_minutes: duration, allow_retakes: allowRetakes })
                    }} 
                ...
                >
                    ...
                    >
                        {createMutation.isPending ? 'Создание...' : <><Save size={18} /> Создать тест</>}
                    </button>
                </form>
            </main>
